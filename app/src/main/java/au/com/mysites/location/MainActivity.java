...
public class MainActivity extends AppCompatActivity {
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                mLastLocation = null;
                                Toast.makeText(getApplicationContext(), getString(R.string.location_null), Toast.LENGTH_SHORT).show();
                            }
                        }
                    })
    ...
    /**
     * display latitude and longitude for the supplied location
     */
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constant.SUCCESS_RESULT) {
                ...
                Toast.makeText(getApplicationContext(), getString(R.string.location_fail), Toast.LENGTH_SHORT).show();
            }
        }
    }
//endregion
